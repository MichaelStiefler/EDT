 ...
 *          If you need to call any Library methods at application start in one of the above mentioned methods, you should use the {@link LibraryCallback Callback} Mechanism offered by the {@link LibraryCallback#onLibraryReady onLibraryReady} method instead.<br/>
...
public interface LibraryCallback {
     ...
     */
    void onLibraryReady() throws RemoteException, UnsupportedOperationException;
}
