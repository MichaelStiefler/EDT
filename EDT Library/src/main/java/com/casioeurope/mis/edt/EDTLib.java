...
/**
 * The CASIO Enterprise Developer Tools Library Main Class<br/>
 * This Class holds all common methods to be used by a Developer
 */
public class EDTLib {
    ...
    /**
     * Displays a Toast Message containing the specified String.<br/>
    ...
    /**
     * Locks the Device (i.e. device needs to be unlocked to be used further on)<br/>
    ...
    /**
     * Performs a factory reset of the device<br/>
     * CAUTION: This wipes all data off the device!<br/>
     * CAUTION: If there's a Google Account active on the device at factory reset time, you will
     *          need to login to that account after reboot (Google Factory Reset Protection)
     ...
     * NOTE: This method usually fails, because certain accounts cannot be removed.<br/>
    ...
    /**
     * Enables/Disables Wifi on demand<br/>
     * If the requested state equals the current state of Wifi, the method returns true without
     ...
     *
     * @apiNote This method follows the specification of the Android API {@link java.nio.file.Files#copy(Path, Path, CopyOption...) copy} method.
     ...
     *
     * @apiNote This method follows the specification of the Android API {@link java.nio.file.Files#move(Path, Path, CopyOption...) move} method.
    ...
    /**
     * Write current Barcode Scanner Settings to file<br/>
     * NOTE: The file may or may not contain a file extension.<br/>
    ...
    /**
     * Apply new Barcode Scanner Settings from file.<br/>
     * NOTE: The file may or may not contain a file extension.<br/>
    ...
    /**
     * Reads current Barcode Scanner settings and applies new Barcode Scanner settings to/from files according to the specified file path<br/>
     * NOTE: The Filename for the old Barcode Scanner setting will get a suffix "_old" applied.<br/>
     *       See {@link #getCurrentScanSettings(String settingsFilePath)} and {@link #setNewScanSettings(String settingsFilePath)} for further details regarding file name and file format specifications
     * @param settingsFilePath {@link java.lang.String String}: Path to the file holding the Scanner settings
    ...
    /**
     * Enables/Disables Bluetooth on demand<br/>
     * If the requested state equals the current state of Bluetooth, the method returns true without
     * performing any action.
    ...
    /**
     * Enables/Disables NFC on demand<br/>
     * If the requested state equals the current state of NFC, the method returns true without
     * performing any action.
    ...
    /**
     * Enables/Disables GPS on demand<br/>
     * If the requested state equals the current state of GPS, the method returns true without
     * performing any action.
    ...
    /**
     * Enables/Disables WWAN (3G/LTE/...) on demand<br/>
     * If the requested state equals the current state of WWAN, the method returns true without
     * performing any action.
    ...
    /**
     * Enables/Disables Developer Mode on demand<br/>
     * If the requested state equals the current state of Developer Mode, the method returns true without
     * performing any action.
    ...
    private com.casioeurope.mis.edt.IEDT edtService() {
