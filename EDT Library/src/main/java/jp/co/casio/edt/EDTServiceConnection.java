...
class EDTServiceConnection implements ServiceConnection {
    ...
    protected boolean bind(Context context) {
        ...
        context.bindService(new Intent("jp.co.casio.edt.service.EDTService").setPackage("jp.co.casio.edt.service")
