...
public class SystemLibraryImpl {
    ...
    public boolean getNavigationBarState() throws RemoteException {
        throw new RemoteException("boolean getNavigationBarState() not supported on DT-X400 devices!");
    }

    public void setNavigationBarState(boolean state) throws RemoteException {
        throw new RemoteException("void setNavigationBarState(boolean state) not supported on DT-X400 devices!");
    }
