...
public class KeyLibraryImpl extends IKeyLibrary.Stub {
    ...
    public int setLaunchApplication(int nID, ApplicationInfo appInfo, BooleanParcelable unsupported) throws RemoteException {
        unsupported.setValue(false);
        return getJpInstance().setLaunchApplication(nID, appInfo(appInfo));
    }

    public int getLaunchApplication(int nID, ApplicationInfo appInfo, BooleanParcelable unsupported) throws RemoteException {
        unsupported.setValue(false);
    ...
    public int setFnLaunchApplication(int nID, ApplicationInfo appInfo, BooleanParcelable unsupported) throws RemoteException {
        unsupported.setValue(false);
        return getJpInstance().setFnLaunchApplication(nID, appInfo(appInfo));
    }

    public int getFnLaunchApplication(int nID, ApplicationInfo appInfo, BooleanParcelable unsupported) throws RemoteException {
        unsupported.setValue(false);
